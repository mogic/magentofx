...
function Minicart(options) {
    ...
    this.selectors = {
        ...
        qty:                  'span.fx-minicart-badge',
        overlay:              '.loading-container',
        error:                '#minicart-error-message',
        success:              '#minicart-success-message',
		successCssRef:        'minicart-success-message-style',
		errorCssRef:          'minicart-error-message-style',
...
Minicart.prototype = {
    ...
    showError: function(message) {
        $j(this.selectors.error).addClass(this.selectors.errorCssRef).text(message).fadeIn('slow');
    },

    showSuccess: function(message) {
        $j(this.selectors.success).addClass(this.selectors.successCssRef).text(message).fadeIn('slow');
    }
};
